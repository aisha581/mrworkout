    ...
    return (
        <div className="fixed inset-0 bg-[#060606] flex flex-col items-center justify-center px-8 text-center">
            ...
            >
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.6em] opacity-40">Welcome to</p>
                <h1
                ...
                <p className="text-sm opacity-40 font-medium">All 89 moves unlocked. Build anything.</p>
                <motion.button
                    whileTap={{ scale: 0.96 }}
